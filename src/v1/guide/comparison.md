...
That said, it would probably make a better comparison between Vue core and Ember's [templating](https://guides.emberjs.com/v1.10.0/templates/handlebars-basics/) and [object model](https://guides.emberjs.com/v1.10.0/object-model/) layers:
